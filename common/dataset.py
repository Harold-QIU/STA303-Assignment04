...
def build_dataset(dataset_name, transform=None, mode='train'):
    ...
    if dataset_name == 'imagenet':
        ...
        if mode == "train":
            dataset = dset.MNIST("/data/dataset/", train=True, download=True, transform=transform)
        elif mode == "test":
            dataset = dset.MNIST("/data/dataset/", train=False, download=True, transform=transform)
        ...
        dataset = dset.ImageFolder(data_dir + "/ood_data/iNaturalist", transform)
        ...
        dataset = dset.ImageFolder(data_dir + "/ood_data/SUN", transform)
        ...
        dataset = dset.ImageFolder(data_dir + "/ood_data/dtd/images", transform)
        ...
        dataset = dset.ImageFolder(data_dir + "/ood_data/Places", transform)
        ...
        dataset = dset.CIFAR10("/data/dataset", train=False, download=True, transform=transform)
    else:
