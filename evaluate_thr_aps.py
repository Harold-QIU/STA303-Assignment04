...
argparser.add_argument('--scores', type=str, default="THR")
...
#######################################    
alpha = 0.1
print(f"Experiment--Data : ImageNet, Model : {model_name}, Score : {args.scores}, Predictor : {args.predictors}, Alpha : {alpha}")

if args.scores == "THR":
    score_function = THR()
elif args.scores == "APS":
    score_function = APS()
else:
